...
```bash
./src/ammocoin-cli sendtoaddress "AeLWWVfT293noSbYpRJBN6xMsKk5ksgggC" 13690696.25046043
```

**Verify it arrived:**
```bash
./src/ammocoin-cli getreceivedbyaddress "AeLWWVfT293noSbYpRJBN6xMsKk5ksgggC"
```

**⚠️ CRITICAL: Back up the private key for this address!**

```bash
./src/ammocoin-cli dumpprivkey "AeLWWVfT293noSbYpRJBN6xMsKk5ksgggC"
```
...
📊 MIGRATION FUND STATISTICS
============================================================
Migration fund address: AeLWWVfT293noSbYpRJBN6xMsKk5ksgggC
