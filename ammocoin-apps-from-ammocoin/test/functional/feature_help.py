...
"""Verify that starting ammocoin with -h works as expected."""
...
class HelpTest(AMMOcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ammocoin with -? for help text")
        ...
        self.log.info("Start ammocoin with -version for version information")
