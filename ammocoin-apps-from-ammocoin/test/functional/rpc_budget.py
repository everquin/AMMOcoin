...
class BudgetProposalTest(AMMOcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test with invalid AMMOcoin address")
        assert_raises_rpc_error(-5, "Invalid AMMOcoin address", self.nodes[0].preparebudget,
