...
# Copyright (c) 2020-2022 The AMMOcoin Core developers
...
class FullBlockTest(AMMOcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure ammocoind isn't accepting b26
        ...
        # Extend the b28 chain to make sure ammocoind isn't accepting b28
        ...
        # AMMOcoin: timestamp checks disabled for regtest
        ...
        #    Low-S and High-S values (whereas the ammocoin code has custom code which does so);
