...
from test_framework.test_framework import AMMOcoinTestFramework, SkipTest
...
class ZMQTest (AMMOcoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that ammocoin has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("ammocoind has not been built with zmq enabled.")
