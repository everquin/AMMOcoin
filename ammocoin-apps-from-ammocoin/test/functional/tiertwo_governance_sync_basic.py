...
from test_framework.test_framework import AMMOcoinTier2TestFramework
...
class MasternodeGovernanceBasicTest(AMMOcoinTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposal = Proposal(
            "super-cool",
            "https://forum.ammocoin.org/t/test-proposal",
            2,
