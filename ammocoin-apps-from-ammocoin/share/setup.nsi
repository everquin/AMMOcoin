...
!define COMPANY "AMMOcoin Core project"
...
VIAddVersionKey ProductName "AMMOcoin Core"
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\AMMOcoin Core (testnet, 64-bit).lnk"
    Delete /REBOOTOK "$SMSTARTUP\AMMOcoin.lnk"
