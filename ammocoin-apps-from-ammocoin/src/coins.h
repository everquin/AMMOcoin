...
public:
    ...
    /**
     * Amount of ammocoin coming in to a transaction
...
// AMMOcoin: When check is false, this assumes that overwrites are never possible due to BIP34 always in effect
