...
QT_MOC_LITERAL(4, 57, 9), // "recipient"
QT_MOC_LITERAL(5, 67, 7), // "message"
QT_MOC_LITERAL(6, 75, 5), // "title"
QT_MOC_LITERAL(7, 81, 5), // "style"
QT_MOC_LITERAL(8, 87, 7), // "uiReady"
QT_MOC_LITERAL(9, 95, 15), // "handleURIOrFile"
QT_MOC_LITERAL(10, 111, 1), // "s"
QT_MOC_LITERAL(11, 113, 19) // "handleURIConnection"

    },
    "PaymentServer\0receivedPaymentRequest\0"
    "\0SendCoinsRecipient\0recipient\0message\0"
    "title\0style\0uiReady\0handleURIOrFile\0"
    "s\0handleURIConnection"
};
...
void PaymentServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->receivedPaymentRequest((*reinterpret_cast< const SendCoinsRecipient(*)>(_a[1]))); break;
        ...
        {
            using _t = void (PaymentServer::*)(const SendCoinsRecipient & );
...
// SIGNAL 0
void PaymentServer::receivedPaymentRequest(const SendCoinsRecipient & _t1)
{
