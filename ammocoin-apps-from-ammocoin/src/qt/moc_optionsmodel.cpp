...
QT_MOC_LITERAL(4, 38, 26), // "coinControlFeaturesChanged"
QT_MOC_LITERAL(5, 65, 25), // "showHideColdStakingScreen"
QT_MOC_LITERAL(6, 91, 17), // "hideChartsChanged"
QT_MOC_LITERAL(7, 109, 23), // "hideZeroBalancesChanged"
QT_MOC_LITERAL(8, 133, 18) // "hideOrphansChanged"

    },
    "OptionsModel\0displayUnitChanged\0\0unit\0"
    "coinControlFeaturesChanged\0"
    "showHideColdStakingScreen\0hideChartsChanged\0"
...
void OptionsModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->showHideColdStakingScreen((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 3: _t->hideChartsChanged((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 4: _t->hideZeroBalancesChanged((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 5: _t->hideOrphansChanged((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (OptionsModel::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OptionsModel::showHideColdStakingScreen)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (OptionsModel::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OptionsModel::hideChartsChanged)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 2
void OptionsModel::showHideColdStakingScreen(bool _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 3
void OptionsModel::hideChartsChanged(bool _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
