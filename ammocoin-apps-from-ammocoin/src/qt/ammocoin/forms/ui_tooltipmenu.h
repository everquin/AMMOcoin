...
public:
    ...
    void setupUi(QWidget *TooltipMenu)
    {
        ...
        sizePolicy.setHeightForWidth(btnLast->sizePolicy().hasHeightForWidth());
        btnLast->setSizePolicy(sizePolicy);
        btnLast->setMinimumSize(QSize(0, 30));
        btnLast->setMaximumSize(QSize(16777215, 30));
        btnLast->setFocusPolicy(Qt::NoFocus);

        verticalLayout_3->addWidget(btnLast, 0, Qt::AlignLeft);
    ...
    {
        btnCopy->setText(QCoreApplication::translate("TooltipMenu", "Copy", nullptr));
        btnEdit->setText(QCoreApplication::translate("TooltipMenu", "Edit", nullptr));
        btnDelete->setText(QCoreApplication::translate("TooltipMenu", "Delete", nullptr));
        btnLast->setText(QCoreApplication::translate("TooltipMenu", "Last", nullptr));
        (void)TooltipMenu;
    } // retranslateUi
