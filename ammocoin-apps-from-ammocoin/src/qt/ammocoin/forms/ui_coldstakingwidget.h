...
public:
    ...
    void setupUi(QWidget *ColdStakingWidget)
    {
        ...
        ColdStakingWidget->setWindowTitle(QString::fromUtf8("N/A"));
...
"                   padding:0px;"));
    ...
    void retranslateUi(QWidget *ColdStakingWidget)
    {
        ...
        labelSubtitle1->setText(QCoreApplication::translate("ColdStakingWidget", "You can delegate your PIVs, letting a hot node (24/7 online node)\n"
"stake on your behalf, while you keep the keys securely offline.", nullptr));
        ...
        labelSubtitle2->setText(QCoreApplication::translate("ColdStakingWidget", "Accept PIV delegation / Delegate PIV", nullptr));
        ...
        lineEditFilter->setPlaceholderText(QCoreApplication::translate("ColdStakingWidget", "Filter", nullptr));
