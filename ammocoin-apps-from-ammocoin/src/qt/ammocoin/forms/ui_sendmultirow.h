...
public:
    ...
    void setupUi(QWidget *SendMultiRow)
    {
        ...
        lineEditAmount->setPlaceholderText(QString::fromUtf8("0.00 PIV"));
...
"padding:0px;"));
        ...
        containerMemo = new QWidget(layoutLabel);
        containerMemo->setObjectName(QString::fromUtf8("containerMemo"));
        horizontalLayout_5 = new QHBoxLayout(containerMemo);
        horizontalLayout_5->setObjectName(QString::fromUtf8("horizontalLayout_5"));
        horizontalLayout_5->setContentsMargins(0, 0, 0, 0);
        checkboxSubtractFeeFromAmount = new QCheckBox(containerMemo);
        checkboxSubtractFeeFromAmount->setObjectName(QString::fromUtf8("checkboxSubtractFeeFromAmount"));

        horizontalLayout_5->addWidget(checkboxSubtractFeeFromAmount);

        horizontalSpacer = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        horizontalLayout_5->addItem(horizontalSpacer);

        btnAddMemo = new QPushButton(containerMemo);
        btnAddMemo->setObjectName(QString::fromUtf8("btnAddMemo"));
        btnAddMemo->setText(QString::fromUtf8("Add Encrypted Memo"));

        horizontalLayout_5->addWidget(btnAddMemo);


        verticalLayout_9->addWidget(containerMemo);
    ...
    void retranslateUi(QWidget *SendMultiRow)
    {
        ...
        checkboxSubtractFeeFromAmount->setToolTip(QCoreApplication::translate("SendMultiRow", "The fee will be deducted from the amount being sent. The recipient will receive less PIV than you enter in the amount field. If multiple recipients are selected, the fee is split equally.", nullptr));
#endif // QT_CONFIG(tooltip)
        checkboxSubtractFeeFromAmount->setText(QCoreApplication::translate("SendMultiRow", "Subtract fee from amount", nullptr));
        (void)SendMultiRow;
    } // retranslateUi
