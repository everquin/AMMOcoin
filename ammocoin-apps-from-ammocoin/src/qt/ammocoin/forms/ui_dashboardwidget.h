...
public:
    ...
    void setupUi(QWidget *DashboardWidget)
    {
        ...
        DashboardWidget->setWindowTitle(QString::fromUtf8("N/A"));
        ...
        labelAmountPiv->setText(QString::fromUtf8("0 Stakes"));
        labelAmountPiv->setAlignment(Qt::AlignCenter);

        horizontalLayout_5->addWidget(labelAmountPiv);

        labelAmountMN = new QLabel(right);
        labelAmountMN->setObjectName(QString::fromUtf8("labelAmountMN"));
        labelAmountMN->setText(QString::fromUtf8("0 MN"));
        labelAmountMN->setAlignment(Qt::AlignCenter);

        horizontalLayout_5->addWidget(labelAmountMN);
        ...
        labelPiv->setText(QString::fromUtf8("Stakes"));
        ...
        labelSquareMN = new QLabel(verticalWidgetChart);
        labelSquareMN->setObjectName(QString::fromUtf8("labelSquareMN"));
        labelSquareMN->setMinimumSize(QSize(14, 14));
        labelSquareMN->setMaximumSize(QSize(14, 14));

        horizontalLayout_4->addWidget(labelSquareMN);

        labelMN = new QLabel(verticalWidgetChart);
        labelMN->setObjectName(QString::fromUtf8("labelMN"));

        horizontalLayout_4->addWidget(labelMN);
...
"}"));
    ...
    void retranslateUi(QWidget *DashboardWidget)
    {
        ...
        btnHowTo->setText(QCoreApplication::translate("DashboardWidget", "How to get PIV", nullptr));
        labelTitle2->setText(QCoreApplication::translate("DashboardWidget", "Staking/MN Rewards", nullptr));
        labelMessage->setText(QCoreApplication::translate("DashboardWidget", "Amount of PIV stakes and masternodes rewards.", nullptr));
        labelChart->setText(QCoreApplication::translate("DashboardWidget", "Rewards statistics", nullptr));
        labelSquarePiv->setText(QString());
        labelSquareMN->setText(QString());
        labelMN->setText(QCoreApplication::translate("DashboardWidget", "Masternode", nullptr));
