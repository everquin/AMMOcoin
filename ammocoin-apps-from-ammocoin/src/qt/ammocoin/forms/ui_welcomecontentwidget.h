...
public:
    ...
    void setupUi(QDialog *WelcomeContentWidget)
    {
        if (WelcomeContentWidget->objectName().isEmpty())
            WelcomeContentWidget->setObjectName(QString::fromUtf8("WelcomeContentWidget"));
        WelcomeContentWidget->resize(1200, 750);
        WelcomeContentWidget->setWindowTitle(QString::fromUtf8("N/A"));
        ...
        layoutIcon1_2->setObjectName(QString::fromUtf8("layoutIcon1_2"));
        ...
        labelLine1->setMaximumSize(QSize(140, 1));
        ...
        layoutIcon2_2->setObjectName(QString::fromUtf8("layoutIcon2_2"));
        ...
        pushName4->setMinimumSize(QSize(150, 0));
        ...
        horizontalSpacer_6 = new QSpacerItem(76, 20, QSizePolicy::Fixed, QSizePolicy::Minimum);
        ...
        labelTitle2->setStyleSheet(QString::fromUtf8("padding:1px;"));
        ...
        labelMessage2->setObjectName(QString::fromUtf8("labelMessage2"));
        ...
        labelMessage4->setObjectName(QString::fromUtf8("labelMessage4"));
    ...
    void retranslateUi(QDialog *WelcomeContentWidget)
    {
        ...
        pushNumber1->setText(QCoreApplication::translate("WelcomeContentWidget", "1", nullptr));
        labelLine1->setText(QString());
        pushNumber2->setText(QCoreApplication::translate("WelcomeContentWidget", "2", nullptr));
        labelLine2->setText(QString());
        pushNumber3->setText(QCoreApplication::translate("WelcomeContentWidget", "3", nullptr));
        labelLine3->setText(QString());
        pushNumber4->setText(QCoreApplication::translate("WelcomeContentWidget", "4", nullptr));
        groupBoxName->setTitle(QString());
        pushName1->setText(QCoreApplication::translate("WelcomeContentWidget", "Language", nullptr));
        pushName2->setText(QCoreApplication::translate("WelcomeContentWidget", "Welcome", nullptr));
        pushName3->setText(QCoreApplication::translate("WelcomeContentWidget", "Privacy", nullptr));
        pushName4->setText(QCoreApplication::translate("WelcomeContentWidget", "Masternodes", nullptr));
        labelTitle1->setText(QCoreApplication::translate("WelcomeContentWidget", "Select your language", nullptr));
        labelTitle2->setText(QCoreApplication::translate("WelcomeContentWidget", "Welcome to\n"
"%1 Wallet", nullptr));
        labelMessage2->setText(QCoreApplication::translate("WelcomeContentWidget", "AMMOcoin is the world\342\200\231s most innovative Proof of Stake blockchain based technology. Developed by a team of highly experienced developers and cryptographers.", nullptr));
        labelTitle3->setText(QCoreApplication::translate("WelcomeContentWidget", "How AMMOcoin respects your privacy?", nullptr));
        labelMessage3->setText(QCoreApplication::translate("WelcomeContentWidget", "<html><head/><body><p>As our manifesto says: Privacy is a non-negotiable basic human right; it grants users the freedom to share their data whenever and with whomever they want - AMMOcoin believes in self sovereignty.</p></body></html>", nullptr));
        labelTitle4->setText(QCoreApplication::translate("WelcomeContentWidget", "What is a Masternode?", nullptr));
        labelMessage4->setText(QCoreApplication::translate("WelcomeContentWidget", "The masternode network is AMMOcoin's second layer network on top of the blockchain that enables our DAO to provide decentralized governance and a treasury.", nullptr));
        (void)WelcomeContentWidget;
    } // retranslateUi
