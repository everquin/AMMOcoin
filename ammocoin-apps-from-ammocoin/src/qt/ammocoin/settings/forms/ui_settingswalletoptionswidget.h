...
public:
    ...
    QSpacerItem *horizontalSpacerNetwork;
    QWidget *containerNetworkActivity;
    QVBoxLayout *verticalLayout_5;
    QGroupBox *groupBox_2;
    QHBoxLayout *horizontalLayout_7;
    QPushButton *pushNetEnable;
    QPushButton *pushNetDisable;
    QLabel *labelNetActivity;
    ...
    void setupUi(QWidget *SettingsWalletOptionsWidget)
    {
        ...
        SettingsWalletOptionsWidget->setWindowTitle(QString::fromUtf8("N/A"));
        ...
        horizontalSpacerNetwork = new QSpacerItem(40, 20, QSizePolicy::Minimum, QSizePolicy::Minimum);

        horizontalLayout_2->addItem(horizontalSpacerNetwork);

        containerNetworkActivity = new QWidget(left);
        containerNetworkActivity->setObjectName(QString::fromUtf8("containerNetworkActivity"));
        QSizePolicy sizePolicy(QSizePolicy::Minimum, QSizePolicy::Minimum);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(containerNetworkActivity->sizePolicy().hasHeightForWidth());
        containerNetworkActivity->setSizePolicy(sizePolicy);
        verticalLayout_5 = new QVBoxLayout(containerNetworkActivity);
        verticalLayout_5->setSpacing(5);
        verticalLayout_5->setObjectName(QString::fromUtf8("verticalLayout_5"));
        verticalLayout_5->setContentsMargins(0, 0, 0, 0);
        groupBox_2 = new QGroupBox(containerNetworkActivity);
        ...
        pushNetEnable = new QPushButton(groupBox_2);
        pushNetEnable->setObjectName(QString::fromUtf8("pushNetEnable"));
        pushNetEnable->setMinimumSize(QSize(120, 30));
        pushNetEnable->setMaximumSize(QSize(120, 30));
        pushNetEnable->setFocusPolicy(Qt::NoFocus);
        pushNetEnable->setCheckable(true);
        pushNetEnable->setAutoExclusive(true);

        horizontalLayout_7->addWidget(pushNetEnable, 0, Qt::AlignRight);

        pushNetDisable = new QPushButton(groupBox_2);
        pushNetDisable->setObjectName(QString::fromUtf8("pushNetDisable"));
        pushNetDisable->setMinimumSize(QSize(120, 30));
        pushNetDisable->setMaximumSize(QSize(120, 30));
        pushNetDisable->setFocusPolicy(Qt::NoFocus);
        pushNetDisable->setCheckable(true);
        pushNetDisable->setChecked(true);
        pushNetDisable->setAutoExclusive(true);

        horizontalLayout_7->addWidget(pushNetDisable, 0, Qt::AlignLeft);


        verticalLayout_5->addWidget(groupBox_2);

        labelNetActivity = new QLabel(containerNetworkActivity);
        labelNetActivity->setObjectName(QString::fromUtf8("labelNetActivity"));
        labelNetActivity->setStyleSheet(QString::fromUtf8(""));
        labelNetActivity->setAlignment(Qt::AlignCenter);
        labelNetActivity->setIndent(0);

        verticalLayout_5->addWidget(labelNetActivity);


        horizontalLayout_2->addWidget(containerNetworkActivity, 0, Qt::AlignRight);
        ...
        mapPortUpnp = new QCheckBox(groupBox_1);
        mapPortUpnp->setObjectName(QString::fromUtf8("mapPortUpnp"));

        verticalLayout_4->addWidget(mapPortUpnp);

        mapPortNatpmp = new QCheckBox(groupBox_1);
        mapPortNatpmp->setObjectName(QString::fromUtf8("mapPortNatpmp"));

        verticalLayout_4->addWidget(mapPortNatpmp);
    ...
    void retranslateUi(QWidget *SettingsWalletOptionsWidget)
    {
        ...
        pushNetEnable->setText(QCoreApplication::translate("SettingsWalletOptionsWidget", "Enable", nullptr));
        pushNetDisable->setText(QCoreApplication::translate("SettingsWalletOptionsWidget", "Disable", nullptr));
        labelNetActivity->setText(QCoreApplication::translate("SettingsWalletOptionsWidget", "Enable or disable network activity", nullptr));
        groupBox_1->setTitle(QString());
        mapPortUpnp->setText(QCoreApplication::translate("SettingsWalletOptionsWidget", "Map port using UPnP", nullptr));
#if QT_CONFIG(tooltip)
        mapPortNatpmp->setToolTip(QCoreApplication::translate("SettingsWalletOptionsWidget", "Automatically open the AMMOcoin client port on the router. This only works when your router supports NAT-PMP and it is enabled. The external port could be random.", nullptr));
#endif // QT_CONFIG(tooltip)
        mapPortNatpmp->setText(QCoreApplication::translate("SettingsWalletOptionsWidget", "Map port using NAT-PMP", nullptr));
        ...
        (void)SettingsWalletOptionsWidget;
    } // retranslateUi
