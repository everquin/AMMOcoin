...
void SettingsWalletRepairWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SettingsWalletRepairWidget *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (SettingsWalletRepairWidget::*)(QStringList );
...
QT_INIT_METAOBJECT const QMetaObject SettingsWalletRepairWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<PWidget::staticMetaObject>(),
    qt_meta_stringdata_SettingsWalletRepairWidget.data,
    qt_meta_data_SettingsWalletRepairWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
