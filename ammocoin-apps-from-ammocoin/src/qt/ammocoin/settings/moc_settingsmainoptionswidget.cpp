...
QT_MOC_LITERAL(1, 26, 12), // "saveSettings"
QT_MOC_LITERAL(2, 39, 0), // ""
QT_MOC_LITERAL(3, 40, 15), // "discardSettings"
QT_MOC_LITERAL(4, 56, 14) // "onResetClicked"

    },
    "SettingsMainOptionsWidget\0saveSettings\0"
...
void SettingsMainOptionsWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SettingsMainOptionsWidget *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (SettingsMainOptionsWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SettingsMainOptionsWidget::saveSettings)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SettingsMainOptionsWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SettingsMainOptionsWidget::discardSettings)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject SettingsMainOptionsWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<PWidget::staticMetaObject>(),
    qt_meta_stringdata_SettingsMainOptionsWidget.data,
    qt_meta_data_SettingsMainOptionsWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void SettingsMainOptionsWidget::saveSettings()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void SettingsMainOptionsWidget::discardSettings()
{
