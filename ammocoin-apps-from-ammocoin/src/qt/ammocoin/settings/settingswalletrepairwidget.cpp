...
#include "qt/ammocoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/ammocoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(AMMOCOINGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to AMMOCOINGUI::handleRestart()
