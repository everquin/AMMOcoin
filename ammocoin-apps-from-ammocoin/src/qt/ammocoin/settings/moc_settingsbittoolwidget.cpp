...
void SettingsBitToolWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SettingsBitToolWidget *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject SettingsBitToolWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<PWidget::staticMetaObject>(),
    qt_meta_stringdata_SettingsBitToolWidget.data,
    qt_meta_data_SettingsBitToolWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
