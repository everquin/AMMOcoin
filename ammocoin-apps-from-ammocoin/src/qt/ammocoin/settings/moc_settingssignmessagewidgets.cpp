...
QT_MOC_LITERAL(4, 73, 11), // "onGoClicked"
QT_MOC_LITERAL(5, 85, 10), // "onClearAll"
QT_MOC_LITERAL(6, 96, 18), // "onAddressesClicked"
QT_MOC_LITERAL(7, 115, 14), // "onModeSelected"
QT_MOC_LITERAL(8, 130, 6), // "isSign"
QT_MOC_LITERAL(9, 137, 10) // "updateMode"

    },
    "SettingsSignMessageWidgets\0"
    "onSignMessageButtonSMClicked\0\0"
    "onVerifyMessage\0onGoClicked\0onClearAll\0"
    "onAddressesClicked\0onModeSelected\0"
    "isSign\0updateMode"
};
...
void SettingsSignMessageWidgets::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SettingsSignMessageWidgets *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->onSignMessageButtonSMClicked(); break;
        case 1: _t->onVerifyMessage(); break;
        case 2: _t->onGoClicked(); break;
        case 3: _t->onClearAll(); break;
        case 4: _t->onAddressesClicked(); break;
        case 5: _t->onModeSelected((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 6: _t->updateMode(); break;
        default: ;
        }
    }
}

QT_INIT_METAOBJECT const QMetaObject SettingsSignMessageWidgets::staticMetaObject = { {
    QMetaObject::SuperData::link<PWidget::staticMetaObject>(),
    qt_meta_stringdata_SettingsSignMessageWidgets.data,
    qt_meta_data_SettingsSignMessageWidgets,
    qt_static_metacall,
    nullptr,
    nullptr
} };
