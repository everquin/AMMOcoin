...
QT_MOC_LITERAL(4, 30, 15), // "onInputsClicked"
QT_MOC_LITERAL(5, 46, 16) // "onOutputsClicked"

    },
    "TxDetailDialog\0accept\0\0reject\0"
    "onInputsClicked\0onOutputsClicked"
};
...
void TxDetailDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TxDetailDialog *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->accept(); break;
        case 1: _t->reject(); break;
        case 2: _t->onInputsClicked(); break;
        case 3: _t->onOutputsClicked(); break;
        default: ;
        }
    }
    (void)_a;
...
QT_INIT_METAOBJECT const QMetaObject TxDetailDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<FocusedDialog::staticMetaObject>(),
    qt_meta_stringdata_TxDetailDialog.data,
    qt_meta_data_TxDetailDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
