...
QT_MOC_LITERAL(7, 72, 5) // "index"
    ...
    "address\0label\0handleClick\0QModelIndex\0"
    "index"
};
...
void ContactsDropdown::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ContactsDropdown *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (ContactsDropdown::*)(QString , QString );
...
QT_INIT_METAOBJECT const QMetaObject ContactsDropdown::staticMetaObject = { {
    QMetaObject::SuperData::link<PWidget::staticMetaObject>(),
    qt_meta_stringdata_ContactsDropdown.data,
    qt_meta_data_ContactsDropdown,
    qt_static_metacall,
    nullptr,
    nullptr
} };
