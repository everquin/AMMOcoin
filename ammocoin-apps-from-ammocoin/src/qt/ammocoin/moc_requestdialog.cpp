...
QT_MOC_LITERAL(3, 22, 13), // "onCopyClicked"
QT_MOC_LITERAL(4, 36, 16) // "onCopyUriClicked"

    },
    "RequestDialog\0accept\0\0onCopyClicked\0"
    "onCopyUriClicked"
};
...
void RequestDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RequestDialog *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject RequestDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<FocusedDialog::staticMetaObject>(),
    qt_meta_stringdata_RequestDialog.data,
    qt_meta_data_RequestDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
