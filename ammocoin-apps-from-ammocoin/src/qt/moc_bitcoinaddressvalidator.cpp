...
QT_INIT_METAOBJECT const QMetaObject BitcoinAddressEntryValidator::staticMetaObject = { {
    ...
    qt_meta_stringdata_BitcoinAddressEntryValidator.data,
    qt_meta_data_BitcoinAddressEntryValidator,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
QT_INIT_METAOBJECT const QMetaObject BitcoinAddressCheckValidator::staticMetaObject = { {
    QMetaObject::SuperData::link<QValidator::staticMetaObject>(),
    qt_meta_stringdata_BitcoinAddressCheckValidator.data,
    qt_meta_data_BitcoinAddressCheckValidator,
    qt_static_metacall,
    nullptr,
    nullptr
} };
