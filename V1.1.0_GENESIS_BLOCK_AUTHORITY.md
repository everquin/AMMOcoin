...
Status: DEPRECATED - Old v1.0 blockchain, completely incompatible with v1.1.0
Reason: Used generic public key, not paper wallet key. Separate blockchain.
```
...
Reason: Hash was manually set instead of computed, nNonce is incorrect for this hash.
```
