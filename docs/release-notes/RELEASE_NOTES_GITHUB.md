...
| File | Description |
|------|-------------|
| [AMMOcoin-macOS-ARM64.dmg](https://github.com/everquin/AMMOcoin/releases/download/v1.1.0/AMMOcoin-macOS-ARM64.dmg) | **Recommended** - Disk image with Qt wallet + CLI tools (67 MB) |
| [AMMOcoin-macOS-ARM64.tar.gz](https://github.com/everquin/AMMOcoin/releases/download/v1.1.0/AMMOcoin-macOS-ARM64.tar.gz) | CLI binaries only (15 MB) |
| [AMMOcoin-macOS-ARM64.zip](https://github.com/everquin/AMMOcoin/releases/download/v1.1.0/AMMOcoin-macOS-ARM64.zip) | CLI binaries only (19 MB) |
...
| File | Description |
|------|-------------|
| [AMMOcoin-Windows-x86_64-Setup.exe](https://github.com/everquin/AMMOcoin/releases/download/v1.1.0/AMMOcoin-Windows-x86_64-Setup.exe) | **Recommended** - NSIS installer with Start Menu, uninstaller, protocol handler (78 MB) |
| [AMMOcoin-Windows-x86_64.tar.gz](https://github.com/everquin/AMMOcoin/releases/download/v1.1.0/AMMOcoin-Windows-x86_64.tar.gz) | Portable binaries (41 MB) |
| [AMMOcoin-Windows-x86_64.zip](https://github.com/everquin/AMMOcoin/releases/download/v1.1.0/AMMOcoin-Windows-x86_64.zip) | Portable binaries (41 MB) |
...
| File | Description |
|------|-------------|
| [AMMOcoin-Linux-amd64.deb](https://github.com/everquin/AMMOcoin/releases/download/v1.1.0/AMMOcoin-Linux-amd64.deb) | **Recommended** - Debian package with systemd service (7 MB) |
| [AMMOcoin-Linux-x86_64.tar.gz](https://github.com/everquin/AMMOcoin/releases/download/v1.1.0/AMMOcoin-Linux-x86_64.tar.gz) | Standalone binaries (11 MB) |
| [AMMOcoin-Linux-x86_64.zip](https://github.com/everquin/AMMOcoin/releases/download/v1.1.0/AMMOcoin-Linux-x86_64.zip) | Standalone binaries (11 MB) |

**Install:**
```bash
sudo dpkg -i AMMOcoin-Linux-amd64.deb
...
| File | Description |
|------|-------------|
| [AMMOcoin-Linux-arm64.deb](https://github.com/everquin/AMMOcoin/releases/download/v1.1.0/AMMOcoin-Linux-arm64.deb) | **Recommended** - Debian package with systemd service, ARM-tuned config (6 MB) |
| [AMMOcoin-Linux-ARM64.tar.gz](https://github.com/everquin/AMMOcoin/releases/download/v1.1.0/AMMOcoin-Linux-ARM64.tar.gz) | Standalone binaries (10 MB) |
| [AMMOcoin-Linux-ARM64.zip](https://github.com/everquin/AMMOcoin/releases/download/v1.1.0/AMMOcoin-Linux-ARM64.zip) | Standalone binaries (10 MB) |

**Install:**
```bash
sudo dpkg -i AMMOcoin-Linux-arm64.deb
sudo systemctl start ammocoind
```

### Checksums

Full checksums file: [AMMOcoin-ALL-PLATFORMS-CHECKSUMS.txt](https://github.com/everquin/AMMOcoin/releases/download/v1.1.0/AMMOcoin-ALL-PLATFORMS-CHECKSUMS.txt)

```
# macOS ARM64
08dfb0be819eba85c3238f916e7c2464d1333f97a71a4c1caa0d9ebcea6fd7b6  AMMOcoin-macOS-ARM64.dmg
feea58d2ec34d7758eefa8d4ca04eb5a3d6e5a98a5d67d19f1d2ff69d07cdeb3  AMMOcoin-macOS-ARM64.tar.gz

# Windows x86_64
e24c16299e123d5929308530d7d3c3f413a35849e88339ceca561f1f5b8f2992  AMMOcoin-Windows-x86_64-Setup.exe
3a4170a4a1f71bcac2e5d33a3b3c83e3df384f2e7fe143d201b8e4e31ee407ac  AMMOcoin-Windows-x86_64.tar.gz

# Linux x86_64
801b371e41bd1d6d4a78c7883a04f6b6f300e610189a7f56e020f3d82ad81f6d  AMMOcoin-Linux-amd64.deb
63f9506060cb1405846189e8e19b4950f2246c143148a9c929df639db5ebf86a  AMMOcoin-Linux-x86_64.tar.gz

# Linux ARM64
ddc1b030968468e0349d266e6b1647850ea1412a52fe5de36a76d0f7149ca65e  AMMOcoin-Linux-arm64.deb
e558220746d595a3d24f7593664d9f63ae8fcce844c967c7a7afcc070bcb043a  AMMOcoin-Linux-ARM64.tar.gz
```
