...
By default, ammocoind will dump mempool on shutdown and
...
class MempoolPersistTest(AMMOcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent ammocoind from writing mempool.dat to disk. Verify that `savemempool` fails")
