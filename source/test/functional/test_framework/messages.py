...
# Objects that map to ammocoind objects, which can be serialized/deserialized
class CAddress:
...
class CBlockHeader:
    __slots__ = ("hash", "hashMerkleRoot", "hashPrevBlock", "nBits", "nNonce",
                 "nTime", "nVersion", "sha256", "hashFinalSaplingRoot", "prevoutStake")
...
class CBlock(CBlockHeader):
    __slots__ = ("vtx", "sig_key", "vchBlockSig", "low_s")
...
class msg_version:
    __slots__ = ("addrFrom", "addrTo", "nNonce", "nRelay", "nServices",
                 "nStartingHeight", "nTime", "nVersion", "strSubVer", "mn_auth_challenge")
    command = b"version"
...
class msg_mnping:
    __slots__ = ("vin", "blockhash", "sigtime", "vch_sig", "mess_version", "cached_hash")
    command = b"mnp"
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in ammocoind indicates these should be deserialized as blocks
