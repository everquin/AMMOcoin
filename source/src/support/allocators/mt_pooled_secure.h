...
#ifndef AMMOCOIN_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
#define AMMOCOIN_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
...
#endif // AMMOCOIN_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
