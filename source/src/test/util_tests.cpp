...
// Copyright (c) 2017-2022 The AMMOcoin Core developers
...
BOOST_AUTO_TEST_CASE(test_Capitalize)
{
    ...
    BOOST_CHECK_EQUAL(Capitalize("ammocoin"), "AMMOcoin");
...
BOOST_AUTO_TEST_CASE(test_validateURL)
{
    ...
    BOOST_CHECK(validateURL("https://foo.bar/"));
    BOOST_CHECK(validateURL("http://ammocoin.foo.bar"));
    BOOST_CHECK(validateURL("https://foo.bar/ammocoin"));
    BOOST_CHECK(validateURL("https://foo.bar/ammocoin/more/"));
    BOOST_CHECK(validateURL("https://142.2.3.1"));
    BOOST_CHECK(validateURL("https://foo_bar.ammocoin.com"));
