...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(AMMO);
    unitlist.append(mAMMO);
    unitlist.append(uAMMO);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case AMMO:
        return QString("ammocoin");
    case mAMMO:
        return QString("mammocoin");
    case uAMMO:
        return QString::fromUtf8("uammocoin");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZammo)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZAMMO)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZAMMO);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZAMMO)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZAMMO));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
