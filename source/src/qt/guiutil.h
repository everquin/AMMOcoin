...
/** Utility functions used by the AMMOcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render AMMOcoin addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZammo = false);
QString formatBalanceWithoutHtml(CAmount amount, int nDisplayUnit = 0, bool isZammo = false);
...
// Parse "ammocoin:" URI into recipient object, return true on successful parsing
