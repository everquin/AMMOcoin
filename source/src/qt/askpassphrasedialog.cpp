...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            AMMOCOINGUI* window = static_cast<AMMOCOINGUI*>(parentWidget());
...
{
    AMMOCOINGUI* gui = static_cast<AMMOCOINGUI*>(parentWidget());
...
{
    hide();
    static_cast<AMMOCOINGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("Your wallet is now encrypted. "
               "Remember that encrypting your wallet cannot fully protect "
               "your AMMO from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
