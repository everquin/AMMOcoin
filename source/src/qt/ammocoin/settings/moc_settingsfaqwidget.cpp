...
QT_MOC_LITERAL(6, 68, 7), // "Section"
QT_MOC_LITERAL(7, 76, 8), // "_section"
QT_MOC_LITERAL(8, 85, 12), // "onFaqClicked"
QT_MOC_LITERAL(9, 98, 13), // "QWidget*const"
QT_MOC_LITERAL(10, 112, 6) // "widget"

    },
    "SettingsFaqWidget\0windowResizeEvent\0"
    "\0QResizeEvent*\0event\0setSection\0Section\0"
    "_section\0onFaqClicked\0QWidget*const\0"
    "widget"
};
...
void SettingsFaqWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SettingsFaqWidget *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->windowResizeEvent((*reinterpret_cast< QResizeEvent*(*)>(_a[1]))); break;
        case 1: _t->setSection((*reinterpret_cast< Section(*)>(_a[1]))); break;
...
QT_INIT_METAOBJECT const QMetaObject SettingsFaqWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_SettingsFaqWidget.data,
    qt_meta_data_SettingsFaqWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
