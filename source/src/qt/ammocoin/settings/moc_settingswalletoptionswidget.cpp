...
void SettingsWalletOptionsWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SettingsWalletOptionsWidget *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (SettingsWalletOptionsWidget::*)();
...
QT_INIT_METAOBJECT const QMetaObject SettingsWalletOptionsWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<PWidget::staticMetaObject>(),
    qt_meta_stringdata_SettingsWalletOptionsWidget.data,
    qt_meta_data_SettingsWalletOptionsWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
