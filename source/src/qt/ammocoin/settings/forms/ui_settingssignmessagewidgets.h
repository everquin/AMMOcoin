...
public:
    ...
    void setupUi(QWidget *SettingsSignMessageWidgets)
    {
        ...
        SettingsSignMessageWidgets->setWindowTitle(QString::fromUtf8("N/A"));
...
"}"));
    ...
    void retranslateUi(QWidget *SettingsSignMessageWidgets)
    {
        ...
        labelSubtitleAddress->setText(QCoreApplication::translate("SettingsSignMessageWidgets", "AMMOcoin address or contact label", nullptr));
        ...
        (void)SettingsSignMessageWidgets;
    } // retranslateUi
