...
public:
    ...
    void setupUi(QWidget *SettingsBitToolWidget)
    {
        if (SettingsBitToolWidget->objectName().isEmpty())
            SettingsBitToolWidget->setObjectName(QString::fromUtf8("SettingsBitToolWidget"));
        SettingsBitToolWidget->resize(490, 624);
        SettingsBitToolWidget->setWindowTitle(QString::fromUtf8("N/A"));
        ...
        pageDecrypt->setObjectName(QString::fromUtf8("pageDecrypt"));
        ...
        labelSubtitleKey->setObjectName(QString::fromUtf8("labelSubtitleKey"));
        ...
        labelSubtitlePassphrase->setObjectName(QString::fromUtf8("labelSubtitlePassphrase"));
        ...
        labelSubtitleDecryptResult->setObjectName(QString::fromUtf8("labelSubtitleDecryptResult"));
        ...
        lineEditDecryptResult->setObjectName(QString::fromUtf8("lineEditDecryptResult"));
        ...
        statusLabel_DEC->setObjectName(QString::fromUtf8("statusLabel_DEC"));
        ...
        pushButtonDecryptClear->setObjectName(QString::fromUtf8("pushButtonDecryptClear"));
        ...
        pushButtonDecrypt->setObjectName(QString::fromUtf8("pushButtonDecrypt"));
        ...
        pageEncrypt->setObjectName(QString::fromUtf8("pageEncrypt"));
        ...
        containerAddressEnc->setObjectName(QString::fromUtf8("containerAddressEnc"));
        containerAddressEncLayout = new QVBoxLayout(containerAddressEnc);
        containerAddressEncLayout->setSpacing(5);
        containerAddressEncLayout->setObjectName(QString::fromUtf8("containerAddressEncLayout"));
        ...
        addressIn_ENC->setObjectName(QString::fromUtf8("addressIn_ENC"));
        ...
        passphraseIn_ENC->setObjectName(QString::fromUtf8("passphraseIn_ENC"));
        ...
        labelSubtitleEncryptedKey->setObjectName(QString::fromUtf8("labelSubtitleEncryptedKey"));
        ...
        encryptedKeyOut_ENC->setObjectName(QString::fromUtf8("encryptedKeyOut_ENC"));
        ...
        statusLabel_ENC->setObjectName(QString::fromUtf8("statusLabel_ENC"));
        statusLabel_ENC->setText(QString::fromUtf8("N/A"));
        ...
        pushButtonEncrypt->setFocusPolicy(Qt::NoFocus);
    ...
    {
        labelTitle->setText(QCoreApplication::translate("SettingsBitToolWidget", "BIP38 Tool", nullptr));
        labelSubtitle1->setText(QCoreApplication::translate("SettingsBitToolWidget", "Encrypt your AMMOcoin addresses (key pair actually) using BIP38 encryption.\n"
"Using this mechanism you can share your keys without middle-man risk, only need to store your passphrase safely", nullptr));
        groupBox->setTitle(QString());
        pushLeft->setText(QCoreApplication::translate("SettingsBitToolWidget", "Encrypt", nullptr));
        pushRight->setText(QCoreApplication::translate("SettingsBitToolWidget", "Decrypt", nullptr));
        labelSubtitleKey->setText(QCoreApplication::translate("SettingsBitToolWidget", "Encrypted key", nullptr));
        lineEditKey->setPlaceholderText(QCoreApplication::translate("SettingsBitToolWidget", "Enter a encrypted key", nullptr));
        labelSubtitlePassphrase->setText(QCoreApplication::translate("SettingsBitToolWidget", "Passphrase", nullptr));
        lineEditPassphrase->setPlaceholderText(QCoreApplication::translate("SettingsBitToolWidget", "Enter a passphrase", nullptr));
        labelSubtitleDecryptResult->setText(QCoreApplication::translate("SettingsBitToolWidget", "Decrypted address result", nullptr));
        lineEditDecryptResult->setPlaceholderText(QCoreApplication::translate("SettingsBitToolWidget", "Decrypted Address", nullptr));
        pushButtonImport->setText(QCoreApplication::translate("SettingsBitToolWidget", "Import Address", nullptr));
        statusLabel_DEC->setText(QString());
        pushButtonDecryptClear->setText(QCoreApplication::translate("SettingsBitToolWidget", "CLEAR", nullptr));
        pushButtonDecrypt->setText(QCoreApplication::translate("SettingsBitToolWidget", "DECRYPT KEY", nullptr));
        labelSubtitleAddress->setText(QCoreApplication::translate("SettingsBitToolWidget", "AMMOcoin address", nullptr));
        addressIn_ENC->setPlaceholderText(QCoreApplication::translate("SettingsBitToolWidget", "Enter address", nullptr));
        labelSubtitleMessage->setText(QCoreApplication::translate("SettingsBitToolWidget", "Passphrase", nullptr));
        passphraseIn_ENC->setPlaceholderText(QCoreApplication::translate("SettingsBitToolWidget", "Enter passphrase", nullptr));
        labelSubtitleEncryptedKey->setText(QCoreApplication::translate("SettingsBitToolWidget", "Encrypted Key", nullptr));
        encryptedKeyOut_ENC->setPlaceholderText(QCoreApplication::translate("SettingsBitToolWidget", "Encrypted Key", nullptr));
        pushButtonClear->setText(QCoreApplication::translate("SettingsBitToolWidget", "CLEAR ALL", nullptr));
        pushButtonEncrypt->setText(QCoreApplication::translate("SettingsBitToolWidget", "ENCRYPT", nullptr));
        (void)SettingsBitToolWidget;
    } // retranslateUi
