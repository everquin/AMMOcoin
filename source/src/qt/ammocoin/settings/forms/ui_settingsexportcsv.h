...
public:
    ...
    void setupUi(QWidget *SettingsExportCSV)
    {
        ...
        SettingsExportCSV->setWindowTitle(QString::fromUtf8("N/A"));
    ...
    void retranslateUi(QWidget *SettingsExportCSV)
    {
        ...
        labelSubtitleLocation->setText(QCoreApplication::translate("SettingsExportCSV", "Export Transaction History", nullptr));
