...
public:
    ...
    void setupUi(QWidget *SettingsWidget)
    {
        ...
        SettingsWidget->setWindowTitle(QString::fromUtf8("N/A"));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, -68, 230, 452));
        ...
        pushButtonHelp1->setObjectName(QString::fromUtf8("pushButtonHelp1"));
        pushButtonHelp1->setMinimumSize(QSize(0, 50));
        pushButtonHelp1->setMaximumSize(QSize(16777215, 50));
        pushButtonHelp1->setFocusPolicy(Qt::NoFocus);
    ...
    void retranslateUi(QWidget *SettingsWidget)
    {
        ...
        pushButtonHelp1->setText(QCoreApplication::translate("SettingsWidget", "FAQ", nullptr));
        pushButtonHelp2->setText(QCoreApplication::translate("SettingsWidget", "About AMMOcoin", nullptr));
        (void)SettingsWidget;
    } // retranslateUi
