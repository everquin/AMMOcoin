...
void SettingsConsoleWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SettingsConsoleWidget *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (SettingsConsoleWidget::*)();
        ...
        {
            using _t = void (SettingsConsoleWidget::*)(const QString & );
...
QT_INIT_METAOBJECT const QMetaObject SettingsConsoleWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<PWidget::staticMetaObject>(),
    qt_meta_stringdata_SettingsConsoleWidget.data,
    qt_meta_data_SettingsConsoleWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
