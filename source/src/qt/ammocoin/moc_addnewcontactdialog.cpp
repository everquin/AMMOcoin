...
void AddNewContactDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AddNewContactDialog *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject AddNewContactDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<FocusedDialog::staticMetaObject>(),
    qt_meta_stringdata_AddNewContactDialog.data,
    qt_meta_data_AddNewContactDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
