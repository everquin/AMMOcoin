...
public:
    ...
    void setupUi(QDialog *RequestDialog)
    {
        ...
        RequestDialog->setWindowTitle(QString::fromUtf8("N/A"));
        ...
        comboBoxCoin->setText(QString::fromUtf8("N/A"));
    ...
    void retranslateUi(QDialog *RequestDialog)
    {
        ...
        labelMessage->setText(QCoreApplication::translate("RequestDialog", "Instead of sharing only a AMMOcoin address, you can create a payment request, bundling up more information", nullptr));
