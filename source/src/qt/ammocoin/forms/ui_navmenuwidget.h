...
public:
    ...
    void setupUi(QWidget *NavMenuWidget)
    {
        ...
        NavMenuWidget->setWindowTitle(QString::fromUtf8("N/A"));
...
"}"));
        ...
        btnGovernance = new QToolButton(scrollAreaNavVert);
        btnGovernance->setObjectName(QString::fromUtf8("btnGovernance"));
        ...
        verticalLayout_3->addWidget(btnGovernance);
        ...
        labelVersion->setText(QString::fromUtf8("N/A"));
...
"", nullptr));
        btnGovernance->setText(QCoreApplication::translate("NavMenuWidget", "DAO", nullptr));
