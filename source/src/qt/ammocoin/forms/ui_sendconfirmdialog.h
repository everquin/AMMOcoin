...
public:
    ...
    QWidget *contentMemo;
    QVBoxLayout *contentMemo_layout;
    QHBoxLayout *horizontalLayout_2;
    QLabel *labelMemo;
    QPushButton *pushCopyMemo;
    QPlainTextEdit *textMemo;
    ...
    void setupUi(QWidget *TxDetailDialog)
    {
        ...
        TxDetailDialog->setMinimumSize(QSize(580, 500));
        TxDetailDialog->setWindowTitle(QString::fromUtf8("N/A"));
...
"}"));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 586, 700));
...
"}"));
        ...
        gridInputs->setMinimumSize(QSize(0, 40));
        ...
        verticalLayout_2->addWidget(gridInputs, 0, Qt::AlignTop);
        ...
        textChange->setText(QString::fromUtf8("N/A"));
        ...
        contentMemo = new QWidget(content);
        contentMemo->setObjectName(QString::fromUtf8("contentMemo"));
        contentMemo_layout = new QVBoxLayout(contentMemo);
        contentMemo_layout->setSpacing(0);
        contentMemo_layout->setObjectName(QString::fromUtf8("contentMemo_layout"));
        contentMemo_layout->setContentsMargins(0, 0, 0, 0);
        horizontalLayout_2 = new QHBoxLayout();
        horizontalLayout_2->setSpacing(0);
        horizontalLayout_2->setObjectName(QString::fromUtf8("horizontalLayout_2"));
        labelMemo = new QLabel(contentMemo);
        labelMemo->setObjectName(QString::fromUtf8("labelMemo"));
        labelMemo->setMaximumSize(QSize(16777215, 16777215));
        labelMemo->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignTop);

        horizontalLayout_2->addWidget(labelMemo);

        pushCopyMemo = new QPushButton(contentMemo);
        pushCopyMemo->setObjectName(QString::fromUtf8("pushCopyMemo"));
        pushCopyMemo->setMinimumSize(QSize(34, 34));
        pushCopyMemo->setMaximumSize(QSize(34, 34));
        pushCopyMemo->setFocusPolicy(Qt::NoFocus);
        pushCopyMemo->setIconSize(QSize(18, 18));

        horizontalLayout_2->addWidget(pushCopyMemo);


        contentMemo_layout->addLayout(horizontalLayout_2);

        textMemo = new QPlainTextEdit(contentMemo);
        ...
        sizePolicy3.setHeightForWidth(textMemo->sizePolicy().hasHeightForWidth());
        textMemo->setSizePolicy(sizePolicy3);
        textMemo->setVerticalScrollBarPolicy(Qt::ScrollBarAsNeeded);
        textMemo->setHorizontalScrollBarPolicy(Qt::ScrollBarAlwaysOff);
        textMemo->setSizeAdjustPolicy(QAbstractScrollArea::AdjustToContents);
        textMemo->setUndoRedoEnabled(false);
        textMemo->setReadOnly(true);

        contentMemo_layout->addWidget(textMemo);


        verticalLayout_2->addWidget(contentMemo);
        ...
        verticalLayout_2->addWidget(labelDividerMemo);
        ...
        labelWarning->setText(QString::fromUtf8("N/A"));
    ...
    void retranslateUi(QWidget *TxDetailDialog)
    {
        ...
        labelMemo->setText(QCoreApplication::translate("TxDetailDialog", "Memo", nullptr));
        pushCopyMemo->setText(QString());
