...
public:
    ...
    void setupUi(QWidget *send)
    {
        ...
        send->resize(893, 700);
        send->setWindowTitle(QString::fromUtf8("N/A"));
...
"}"));
        ...
        verticalLayout_6->addWidget(groupBox, 0, Qt::AlignHCenter);

        labelSubtitle2 = new QLabel(left);
        labelSubtitle2->setObjectName(QString::fromUtf8("labelSubtitle2"));
        labelSubtitle2->setStyleSheet(QString::fromUtf8(""));
        labelSubtitle2->setAlignment(Qt::AlignCenter);
        labelSubtitle2->setIndent(0);

        verticalLayout_6->addWidget(labelSubtitle2, 0, Qt::AlignHCenter|Qt::AlignTop);
...
"             }"));
        ...
        labelAmountSend->setText(QString::fromUtf8("0.00 PIV"));
        ...
        btnShieldCoins = new OptionButton(right);
        btnShieldCoins->setObjectName(QString::fromUtf8("btnShieldCoins"));
        btnShieldCoins->setMinimumSize(QSize(0, 50));

        verticalLayout_4->addWidget(btnShieldCoins);
    ...
    void retranslateUi(QWidget *send)
    {
        ...
        labelSubtitle1->setText(QCoreApplication::translate("send", "Transfer coins publicly or privately", nullptr));
        groupBox->setTitle(QString());
        pushLeft->setText(QCoreApplication::translate("send", "Transparent", nullptr));
        pushRight->setText(QCoreApplication::translate("send", "Shielded", nullptr));
        labelSubtitle2->setText(QCoreApplication::translate("send", "Select which coins to spend", nullptr));
        labelSubtitleAddress->setText(QCoreApplication::translate("send", "Recipient address", nullptr));
