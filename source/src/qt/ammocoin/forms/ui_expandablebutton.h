...
public:
    ...
    void setupUi(QWidget *ExpandableButton)
    {
        if (ExpandableButton->objectName().isEmpty())
            ExpandableButton->setObjectName(QString::fromUtf8("ExpandableButton"));
        ...
        ExpandableButton->setWindowTitle(QString::fromUtf8("N/A"));
        ...
        pushButton->setStyleSheet(QString::fromUtf8("padding-right:5px;padding-left:5px;"));
