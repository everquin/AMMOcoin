...
public:
    ...
    void setupUi(QDialog *SendChangeAddressDialog)
    {
        ...
        SendChangeAddressDialog->setWindowTitle(QString::fromUtf8("N/A"));
        ...
        lineEditAddress->setPlaceholderText(QString::fromUtf8("e.g. D8FpnBdmahyJNRsVzoKzyFHbGjcUbX43QN"));
    ...
    void retranslateUi(QDialog *SendChangeAddressDialog)
    {
        ...
        labelMessage->setText(QCoreApplication::translate("SendChangeAddressDialog", "The remainder of the value resultant from the inputs minus the outputs value goes to the \"change\" AMMOcoin address", nullptr));
