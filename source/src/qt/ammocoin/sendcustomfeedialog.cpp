...
#include "qt/ammocoin/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(AMMOCOINGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &AMMOCOINGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
