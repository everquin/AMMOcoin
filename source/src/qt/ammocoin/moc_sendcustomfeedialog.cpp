...
#include <memory>
#include "qt/ammocoin/sendcustomfeedialog.h"
...
QT_MOC_LITERAL(9, 110, 6) // "accept"
    ...
    "isLightTheme\0QString&\0theme\0accept"
};
...
void SendCustomFeeDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SendCustomFeeDialog *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject SendCustomFeeDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<FocusedDialog::staticMetaObject>(),
    qt_meta_stringdata_SendCustomFeeDialog.data,
    qt_meta_data_SendCustomFeeDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
