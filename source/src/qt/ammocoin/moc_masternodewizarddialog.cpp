...
QT_MOC_LITERAL(3, 31, 13) // "onBackClicked"

    },
    "MasterNodeWizardDialog\0accept\0\0"
    "onBackClicked"
};
...
void MasterNodeWizardDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MasterNodeWizardDialog *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject MasterNodeWizardDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<FocusedDialog::staticMetaObject>(),
    qt_meta_stringdata_MasterNodeWizardDialog.data,
    qt_meta_data_MasterNodeWizardDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *MasterNodeWizardDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "PWidget::Translator"))
        return static_cast< PWidget::Translator*>(this);
