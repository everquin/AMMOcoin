...
QT_INIT_METAOBJECT const QMetaObject OptionButton::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_OptionButton.data,
    qt_meta_data_OptionButton,
    qt_static_metacall,
    nullptr,
    nullptr
} };
