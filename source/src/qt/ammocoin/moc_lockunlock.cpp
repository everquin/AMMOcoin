...
#include <memory>
#include "qt/ammocoin/lockunlock.h"
...
void LockUnlock::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<LockUnlock *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (LockUnlock::*)(const StateClicked & );
...
QT_INIT_METAOBJECT const QMetaObject LockUnlock::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_LockUnlock.data,
    qt_meta_data_LockUnlock,
    qt_static_metacall,
    nullptr,
    nullptr
} };
