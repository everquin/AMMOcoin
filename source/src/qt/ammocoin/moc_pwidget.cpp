...
void PWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PWidget *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (PWidget::*)(const QString & , const QString & , unsigned int , bool * );
        ...
        {
            using _t = bool (PWidget::*)(QDialog * , int , int );
...
QT_INIT_METAOBJECT const QMetaObject PWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_PWidget.data,
    qt_meta_data_PWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *PWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Translator"))
        return static_cast< Translator*>(this);
