...
void ExpandableButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ExpandableButton *>(_o);
        (void)_t;
        switch (_id) {
        ...
        case 6: _t->innerMousePressEvent(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ExpandableButton::*)();
...
QT_INIT_METAOBJECT const QMetaObject ExpandableButton::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_ExpandableButton.data,
    qt_meta_data_ExpandableButton,
    qt_static_metacall,
    nullptr,
    nullptr
} };
