...
#error Client version information missing: version is not defined by ammocoin-config.h or in any other way
#endif
...
/**
 * ammocoind-res.rc includes this file, but it cannot cope with real c++ code.
