...
The build script we'll be using is contained in the AMMOcoin github repository ([contrib/gitian-build.py](https://github.com/ammocoin-project/ammocoin/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the AMMOcoin repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/AMMOcoin-Project/AMMOcoin/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, ammocoin-detached-sigs, and ammocoin GitHub repos.
