...
To build AMMOcoin Core using AFL instrumentation (this assumes that the
...
with certain assembly code from AMMOcoin Core's code. See [developer notes on sanitizers](https://github.com/AMMOcoin-Project/AMMOcoin/blob/master/doc/developer-notes.md#sanitizers)
